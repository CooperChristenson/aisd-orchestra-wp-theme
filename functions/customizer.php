...
function set_default_site_icon(){
    if(!has_site_icon()  && !is_customize_preview()){
		echo '<link rel="shortcut icon" type="image/x-icon" href="/wp-content/themes/allenorchestra/assets/images/logos/favicon.png">';
		echo '<link rel="apple-touch-icon" href="/wp-content/themes/allenorchestra/assets/images/logos/favicon.png">';
    }
}
...
add_action( 'customize_register', function($wp_customize){
	...
	$wp_customize->add_setting( 'nav_logo', array(
		'default' => get_template_directory_uri() . '/assets/images/logos/Logo.png',
	...
	$wp_customize->add_setting( 'header_background', array(
		'default' => get_template_directory_uri() . '/assets/images/banners/main_background.png',
		'sanitize_callback' => 'esc_url_raw'
	) );
	...
	$wp_customize->add_setting( 'login_background', array(
		'default' => get_template_directory_uri() . '/assets/images/banners/login-background.png',
		'sanitize_callback' => 'esc_url_raw'
	) );
